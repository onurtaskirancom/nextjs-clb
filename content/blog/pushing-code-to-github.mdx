...
<img className="w-full rounded-xl" src="https://res.cloudinary.com/djfqidbj1/image/upload/v1701517700/m67x1adq9mfuxilifzpx.jpg" alt="onurtaskiran" />
...
<img className="w-full " src="https://res.cloudinary.com/djfqidbj1/image/upload/v1701481897/u3w82jftmqkrqjg5i52b.jpg" alt="onurtaskiran" />

Determine and create a repository name

<img className="w-full " src="https://res.cloudinary.com/djfqidbj1/image/upload/v1701482034/tq4jxnchw1xi2p53bhjb.jpg" alt="onurtaskiran" />
...
git status
```
<img className="w-full " src="https://res.cloudinary.com/djfqidbj1/image/upload/v1701482274/fcrx8zhqzdhh2zr96lma.jpg" alt="onurtaskiran" />
...
git status
```
<img className="w-full " src="https://res.cloudinary.com/djfqidbj1/image/upload/v1701482628/xcwazbpi8ol4iyfwssqv.jpg" alt="onurtaskiran" />
...
```
<img className="w-full " src="https://res.cloudinary.com/djfqidbj1/image/upload/v1701482996/tiqui4kadqypkfuuautn.jpg" alt="onurtaskiran" />

```javascript
git status
```
<img className="w-full " src="https://res.cloudinary.com/djfqidbj1/image/upload/v1701483115/fhp8g1era6cpcd3xhmj0.jpg" alt="onurtaskiran" />
...
git remote -v 
```
<img className="w-full " src="https://res.cloudinary.com/djfqidbj1/image/upload/v1701483311/bpptre4bpqatqphn5rls.jpg" alt="onurtaskiran" />
...
```
<img className="w-full " src="https://res.cloudinary.com/djfqidbj1/image/upload/v1701483424/lghjofuhykdcec043ori.jpg" alt="onurtaskiran" />

All of our code has been pushed to GitHub. I go to the browser and I should see your code here.

<img className="w-full " src="https://res.cloudinary.com/djfqidbj1/image/upload/v1701483494/oz0bb7jihbkliaf6ctyw.jpg" alt="onurtaskiran" />
